...
module.exports = core => {
  ...
  var XPathExpression = xpath.XPathExpression = function XPathExpression(expression, resolver, optDoc) {
    ...
    this._sdAst_201 = parse(stream, astFactory);
    this._sdDoc_201 = optDoc;
  }
  XPathExpression.prototype = {
    evaluate: function evaluate(contextNode, type, result) {
      ...
      if (null != this._sdDoc_201 && this._sdDoc_201 !== doc) {
      ...
      var value = evaluator.val(this._sdAst_201, {nodes: [contextNode]});
